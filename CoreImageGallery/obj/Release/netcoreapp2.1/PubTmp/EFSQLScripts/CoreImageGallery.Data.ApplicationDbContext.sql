...
BEGIN
    ...
    VALUES (N'00000000000000_CreateIdentitySchema', N'2.1.8-servicing-32085');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180516185007_Images')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180516185007_Images', N'2.1.8-servicing-32085');
END;
